...
otcdocs_repo_name = 'opentelekomcloud-docs/cloud-topology-designer'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/cloud-topology-designer/umn/'
otcdocs_doc_title = 'User Guide'
otcdocs_doc_type = 'umn'
otcdocs_service_category = 'other'
otcdocs_service_title = 'Cloud Topology Designer'
otcdocs_service_type = 'ctd'
...
html_title = "Cloud Topology Designer - User Guide"
...
latex_documents = [
    ('index',
     'ctd-umn.tex',
     u'Cloud Topology Designer - User Guide',
